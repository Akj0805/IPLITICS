...
import 'package:test12/CSK_ball.dart';
import 'package:test12/DC_ball.dart';
import 'package:test12/GT_ball.dart';
import 'package:test12/KKR_ball.dart';
import 'package:test12/LSG_ball.dart';
import 'package:test12/MI_ball.dart';
import 'package:test12/PBKS_ball.dart';
import 'package:test12/RCB_ball.dart';
import 'package:test12/RR_ball.dart';
import 'package:test12/SRH_ball.dart';
...
// );
var ballteam1name='';
var bawlername = "error";

class Bowler extends StatefulWidget {
   Bowler( {Key? key}) : super(key: key);

  @override
  _BowlerState createState() =>
      _BowlerState();
...
class _BowlerState extends State<Bowler>
  ...
  List names = ["CSK","RCB","DC","GT","LSG ","KKR","RR","PBKS","MI","SRH"];
  ...
  List  urls = ["images/CSK1.png","images/RCB.jpg","images/DC.jpg","images/GT.png","images/LSG.jpg","images/KKR.png","images/RR.jpg","images/PBKS.jpg","images/MI.png","images/SRH.jpg"];
  List  urls2 = [CSK_ball(),RCB_ball(),DC_ball(),GT_ball(),LSG_ball(),KKR_ball(),RR_ball(),PBKS_ball(),MI_ball(),SRH_ball()];
  @override
  void dispose() {
