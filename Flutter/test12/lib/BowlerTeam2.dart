...
import 'package:test12/ballendpage.dart';
...
String ball60 = 'error';
String ball90 = 'error';
String ball120 = 'error';
var bawlerteam2 = "error";
class BowlerTeam2 extends StatefulWidget {
  BowlerTeam2( {Key? key}) : super(key: key);

  @override
  _BowlerTeam2State createState() =>
      _BowlerTeam2State();
...
class _BowlerTeam2State extends State<BowlerTeam2>
                      ...
                      GestureDetector(
                        onTap: (){
                          if (_isMenuVisible) {
                            ...
                            url = 'http://ec2-13-50-248-10.eu-north-1.compute.amazonaws.com:8080/api2?teamname=' + bawlerteam2+'&bawlername='+bawlername;
                            print(url);
                            Future<void> abc() async {
                              ...
                              setState(() {
                                ball30 = decoded['pred30'];
                                print(ball30);
                                ball60 = decoded['pred60'];
                                ball90 = decoded['pred90'];
                                ball120 = decoded['pred120'];
                              });
                            };
                            abc();
                            void navigate() {
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context) => ballerendpage()));
                            }
