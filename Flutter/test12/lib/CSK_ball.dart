...
class CSK_ball extends StatefulWidget {
  const CSK_ball({Key? key}) : super(key: key);

  @override
  _CSK_ballState createState() =>
      _CSK_ballState();
...
class _CSK_ballState extends State<CSK_ball>
  ...
  List names = ["Maheesh Theekshana","Tushar Deshpande","Adam Milne","Mukesh Choudhary","Chris Jordan"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/MaheeshTheekshana.png","images/TusharDeshpande.png","images/AdamMilne.jpeg","images/MukeshChoudhary.png","images/chrisJordan.png"];
