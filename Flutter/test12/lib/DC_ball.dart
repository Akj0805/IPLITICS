...
class DC_ball extends StatefulWidget {
  const DC_ball({Key? key}) : super(key: key);

  @override
  _DC_ballState createState() =>
      _DC_ballState();
...
class _DC_ballState extends State<DC_ball>
  ...
  List names = ["Kamlesh Nagarkoti","Kuldeep Yadav","Mustafizur Rahman","Anrich Nortje","Chetan Sakariya"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/KamleshNagarkoti.png","images/KuldeepYadav.png","images/MustafizurRahman.png","images/AnrichNortje.png","images/ChetanSakariya.png"];
