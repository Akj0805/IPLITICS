...
class GT_ball extends StatefulWidget {
  const GT_ball({Key? key}) : super(key: key);

  @override
  _GT_ballState createState() =>
      _GT_ballState();
...
class _GT_ballState extends State<GT_ball>
  ...
  List names = ["Mohammed Shami","Varun Aaron","Lockie Ferguson","Rashid Khan","Pradeep Sangwan"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/mohammad shami.png","images/varun aron.jpg","images/lockie fergnson.jpg","images/rashid khan.png","images/pradeep.png"];
  //List  urls2 = [Bowler(),"images/davidwarner.png","images/philipsalt.png","images/lalityadav.png","images/mitchellmarsh.png","images/rovmanpowell.png","images/ripalpatel.png","images/sarfarazkhan.png","images/yashdhull.png","images/rileerossouw.png","images/manishpandey.png"];
