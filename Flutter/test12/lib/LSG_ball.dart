...
class LSG_ball extends StatefulWidget {
  const LSG_ball({Key? key}) : super(key: key);

  @override
  _LSG_ballState createState() =>
      _LSG_ballState();
...
class _LSG_ballState extends State<LSG_ball>
  ...
  List names = ["Krunal Pandya","Dushmantha Chameera","Avesh Khan","Mohsin Khan","Ravi Bishnoi"];
  List designations = ["All Rounder","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/KRUNAL PANDY.jpg","images/DUSHMANTHA CHAMEERA.jpg","images/AVESH KHAN.jpg","images/MOHSIN KHAN.jpg","images/RAVI BISHNOI.jpg"];
  //List  urls2 = [Bowler(),"images/prithvishaw.png","images/davidwarner.png","images/philipsalt.png","images/lalityadav.png","images/mitchellmarsh.png","images/rovmanpowell.png","images/ripalpatel.png","images/sarfarazkhan.png","images/yashdhull.png","images/rileerossouw.png","images/manishpandey.png"];
