...
class MI_ball extends StatefulWidget {
  const MI_ball({Key? key}) : super(key: key);

  @override
  _MI_ballState createState() =>
      _MI_ballState();
...
class _MI_ballState extends State<MI_ball>
  ...
  List names = ["Jasprit Bumrah","Basil Thampi","Murugan Ashwin","Tymal Mills","Jaydev Unadkat"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/JaspritBumrah.png","images/BasilThampi.png","images/MuruganAshwin.jpg","images/TymalMills.png","images/jaayadevunadkat.jpg"];
