...
class PBKS_ball extends StatefulWidget {
  const PBKS_ball({Key? key}) : super(key: key);

  @override
  _PBKS_ballState createState() =>
      _PBKS_ballState();
...
class _PBKS_ballState extends State<PBKS_ball>
  ...
  List names = ["Sandeep Sharma","Arshdeep Singh","Rahul Chahar","Harpreet Brar","Vaibhav Arora"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/SANDEEP SHARMA.jpg","images/ARSHDEEP SINGH.jpg","images/RAHUL CHAHAR.jpg","images/HARSPREET BRAR.jpg","images/vaibhav arora.webp"];
