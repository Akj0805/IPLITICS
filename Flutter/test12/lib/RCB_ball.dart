...
class RCB_ball extends StatefulWidget {
  const RCB_ball({Key? key}) : super(key: key);

  @override
  _RCB_ballState createState() =>
      _RCB_ballState();
...
class _RCB_ballState extends State<RCB_ball>
  ...
  List names = ["Mohammed Siraj","Shahbaz Ahmed","Akash Deep","Harshal Patel","Wanindu Hasaranga de Silva"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/MohammedSiraj.png","images/ShahbazAhmed.png","images/AkashDeep.png","images/HarshalPatel.png","images/WaninduHasaranga.png"];
