...
class RR_ball extends StatefulWidget {
  const RR_ball({Key? key}) : super(key: key);

  @override
  _RR_ballState createState() =>
      _RR_ballState();
...
class _RR_ballState extends State<RR_ball>
  ...
  List names = ["Nathan Coulter-Nile","Trent Boult","Prasidh Krishna","Ravichandran Ashwin","Yuzvendra Chahal"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/nathan coulter nile.jpg","images/trent boult.png","images/prashidh krishna.jpg","images/ravichandran ashwin.png","images/yuvendra chahal.png"];
  //List  urls2 = [Bowler(),GT_ball(),"images/philipsalt.png","images/lalityadav.png","images/mitchellmarsh.png","images/rovmanpowell.png","images/ripalpatel.png","images/sarfarazkhan.png","images/yashdhull.png","images/rileerossouw.png","images/manishpandey.png"];
