...
class SRH_ball extends StatefulWidget {
  const SRH_ball({Key? key}) : super(key: key);

  @override
  _SRH_ballState createState() =>
      _SRH_ballState();
...
class _SRH_ballState extends State<SRH_ball>
  ...
  List names = ["Bhuvneshwar Kumar","Umran Malik","T Natarajan","Sean Abbott","Kartik Tyagi"];
  List designations = ["Bowler","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/bhuvneshwar kumar.png","images/umar malik.png","images/t natranjan.png","images/Sean Abbott.jpg","images/Kartik Tyagi.jpg"];
  //List  urls2 = [Bowler(),GT_ball(),"images/lalityadav.png","images/mitchellmarsh.png","images/rovmanpowell.png","images/ripalpatel.png","images/sarfarazkhan.png","images/yashdhull.png","images/rileerossouw.png","images/manishpandey.png"];
