...
class bat_csk extends StatefulWidget {
  const bat_csk({Key? key}) : super(key: key);

  @override
  _bat_cskState createState() =>
      _bat_cskState();
...
class _bat_cskState extends State<bat_csk>
  ...
  List names = ["Ruturaj Gaikwad","Devon Conway","Moeen Ali","Chris Jordan","Ambati Rayudu","Ravindra Jadeja","MS Dhoni","Shivam Dube","Robin Uthappa","Dwayne Bravo","Dwaine Pretorius"];
  List designations = ["Batsman","Batsman","All Rounder","Bowler","Batsman/Wicket Keeper","All Rounder","Batsman/Wicket Keeper","All Rounder","Batsman","ALL Rounder","All Rounder"];
  List  urls = ["images/ruturaj.jpg","images/devon.jpg","images/moeen.jpg","images/chrisJordan.png","images/ambati.jpg","images/ravindra.webp","images/dhoni.jpg","images/shivam.jpg","images/robin.jpg","images/dwayne.jpg","images/dwaine.jpg"];
