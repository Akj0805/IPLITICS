...
class bat_dc extends StatefulWidget {
  const bat_dc({Key? key}) : super(key: key);

  @override
  _bat_dcState createState() =>
      _bat_dcState();
...
class _bat_dcState extends State<bat_dc>
  ...
  List names = ["Rishabh Pant","Prithvi Shaw","Axar Patel","Mitchell Marsh","Shardul Thakur","Lalit Yadav","Kuldeep Yadav","David Warner","Mandeep Singh","Ripal Patel","Rovman Powell"];
  List designations = ["Wicket Keeper/Batsman","Batsman","All Rounder","All Rounder","Bowler","All Rounder","Bowler","Batsman","Batsman","ALL Rounder","Batsman"];
  List  urls = ["images/rishabh.jpg","images/prithvi.jpg","images/axar.jpg","images/mitchell.jpg","images/ShardulThakur.png","images/lalit.jpg","images/kuldeep.jpg","images/david.jpg","images/mandeep.jpg","images/ripal.jpg","images/rovman.jpg"];
