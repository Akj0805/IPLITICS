...
class bat_gt extends StatefulWidget {
  const bat_gt({Key? key}) : super(key: key);

  @override
  _bat_gtState createState() =>
      _bat_gtState();
...
class _bat_gtState extends State<bat_gt>
  ...
  List names = ["David Miller","Shubman Gill","Matthew Wade","Wriddhiman Saha","Vijay Shankar","Hardik Pandya","Abhinav Manohar","Sai Sudharsan","Odean Smith","Alzarri Joseph","Rahul Tewatia"];
  List designations = ["Batsman","Batsman","Batsman","Wicket Keeper/Batsman","ALL Rounder","ALL Rounder","ALL Rounder","ALL Rounder","ALL Rounder","Bowler","ALL Rounder"];
  List  urls = ["images/david.png","images/shubman.png","images/wade.png","images/saha.png","images/vijay shankar.png","images/hardik.png","images/manohar.png","images/sai.png","images/odean.png","images/alzarri.webp","images/rahul tewatia.png"];
