...
class bat_kkr extends StatefulWidget {
  const bat_kkr({Key? key}) : super(key: key);

  @override
  _bat_kkrState createState() =>
      _bat_kkrState();
...
class _bat_kkrState extends State<bat_kkr>
  ...
  List names = ["Shreyas Iyer","Nitish Rana","Venkatesh Iyer","Sunil Narine","Umesh Yadav","Andre Russell","Harshit Rana","Rinku Singh","Tim Southee","Varun Chakravarthy","Anukul Roy"];
  List designations = ["Batsman","Batsman","All Rounder","All Rounder","Bowler","All Rounder","Bowler","Batsman","Bowler","Bowler","All Rounder"];
  List  urls = ["images/shreyas.jpg","images/nitish.jpg","images/iyer.jpg","images/sunil.jpg","images/umesh.jpg","images/andre.jpg","images/harshit.jpg","images/rinku.jpg","images/TimSouthee.png","images/VarunChakaravarthy.png","images/.anukul.jpg"];
