...
class bat_lsg extends StatefulWidget {
  const bat_lsg({Key? key}) : super(key: key);

  @override
  _bat_lsgState createState() =>
      _bat_lsgState();
...
class _bat_lsgState extends State<bat_lsg>
  ...
  List names = ["KL Rahul","Manan Vohra","Quinton de Kock","Evin Lewis","Ayush Badoni ","Deepak Hooda","Krishnappa Gowtham","Karan Sharma","Krunal Pandya","Marcus Stoinis","Manish Pandey"];
  List designations = ["Batsman","Batsman","Wicket Keeper/Batsman","Batsman","ALL Rounder","ALL Rounder","ALL Rounder","ALL Rounder","ALL Rounder","ALL Rounder","Batsman"];
  List  urls = ["images/kl.png","images/manan.png","images/quinton.png","images/evin lewis.jpg","images/ayush.png","images/deepka.png","images/krishn.png","images/karan.png","images/krunal.png","images/marcus.png","images/MANISH PANDEY.jpg"];
