...
class bat_mi extends StatefulWidget {
  const bat_mi({Key? key}) : super(key: key);

  @override
  _bat_miState createState() =>
      _bat_miState();
...
class _bat_miState extends State<bat_mi>
  ...
  List names = ["Rohit Sharma","Ishan Kishan","Tim David","Hrithik Shokeen","Kieron Pollard","Daniel Sams","Kumar Kartikeya","Tristan Stubbs","Murugan Ashwin","Tilak Varma","Dewald Brevis"];
  List designations = ["Batsman","Batsman","All Rounder","All Rounder","ALL Rounder","All Rounder","Bowler","Batsman","Bowler","Batsman","Batsman"];
  List  urls = ["images/rohit.webp","images/ishan.jpg","images/tim.jpg","images/hrithik.jpg","images/KieronPollard.png","images/DanielSams.jpg","images/kartikeya.jpg","images/trishan.jpg","images/MuruganAshwin.jpg","images/tilak.jpg","images/DewaldBrevis.png"];
