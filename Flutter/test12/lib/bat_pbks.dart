...
class bat_pbks extends StatefulWidget {
  const bat_pbks({Key? key}) : super(key: key);

  @override
  _bat_pbksState createState() =>
      _bat_pbksState();
...
class _bat_pbksState extends State<bat_pbks>
  ...
  List names = ["Shikhar Dhawan","Bhanuka Rajapaksa ","Jitesh Sharma","Jonny Bairstow","Prabhsimran Singh ","Liam Livingstone","M Shahrukh Khan","Rishi Dhawan","Arshdeep Singh","Kagiso Rabada","Mayank Agarwal"];
  List designations = ["Batsman","Batsman","Wicket Keeper/Batsman","Batsman","Batsman","Batsman","Batsman","ALL Rounder","Bowler","Bowler","Batsman"];
  List  urls = ["images/shikhar.jpg","images/bhanuka.png","images/jitesh.png","images/jonny.png","images/prabh.png","images/liam.png","images/shahrukh.png","images/rishi.png","images/arshdeep.png","images/kagiso.png","images/MAYANK AGARWAL.jpg"];
