...
class bat_rcb extends StatefulWidget {
  const bat_rcb({Key? key}) : super(key: key);

  @override
  _bat_rcbState createState() =>
      _bat_rcbState();
...
class _bat_rcbState extends State<bat_rcb>
  ...
  List names = ["Virat Kohli","Faf Du Plessis","Glenn Maxwell","Akash Deep","Harshal Patel","Josh Hazlewood","David Willey","Anuj Rawat","Suyash Prabhudessai","Mohammed Siraj","Wanindu Hasaranga de Silva"];
  List designations = ["Batsman","Batsman","All Rounder","Bowler","Bowler","Bowler","Bowler","Batsman","Batsman","Bowler","Bowler"];
  List  urls = ["images/virat.jpg","images/faf du plessis.jpg","images/glenn.jpg","images/AkashDeep.png","images/harshal.jpg","images/JoshHazlewood","images/david1.jpg","images/anuj.jpg","images/suyash.jpg","images/mohammed siraj.jpg","images/wanindu.jpg"];
