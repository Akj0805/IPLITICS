...
class bat_rr extends StatefulWidget {
  const bat_rr({Key? key}) : super(key: key);

  @override
  _bat_rrState createState() =>
      _bat_rrState();
...
class _bat_rrState extends State<bat_rr>
  ...
  List names = ["Sanju Samson","Devdutt Padikkal","Jos Buttler","Shimron Hetmyer","Yashasvi Jaiswal","Riyan Parag","Ravichandran Ashwin","Trent Boult","Yuzvendra Chahal","Nathan Coulter-Nile","Navdeep Saini"];
  List designations = ["Wicket Keeper/Batsman","Batsman","Batsman","Batsman","Batsman","Batsman","ALL Rounder","Bowler","Bowler","Bowler","Bowler"];
  List  urls = ["images/sanju.png","images/devdutt.png","images/buttler.png","images/shimron.png","images/jaiswal.png","images/parag.png","images/ashwin.png","images/trent boult.png","images/yuvendra chahal.png","images/nathan coulter nile.jpg","images/navdeep.png"];
