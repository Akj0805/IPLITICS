...
class bat_srh extends StatefulWidget {
  const bat_srh({Key? key}) : super(key: key);

  @override
  _bat_srhState createState() =>
      _bat_srhState();
...
class _bat_srhState extends State<bat_srh>
  ...
  List names = ["Abdul Samad","Aiden Markram","Rahul Tripathi","Kane Williamson","Romario Shepherd","Umran Malik","Nicholas Pooran","Abhishek Sharma","Marco Jansen","Washington Sundar","Bhuvneshwar Kumar"];
  List designations = ["Batsman","Batsman","Batsman","Batsman","All Rounder","Bowler","Batsman","ALL Rounder","ALL Rounder","ALL Rounder","Bowler"];
  List  urls = ["images/samad.png","images/aiden.png","images/rahul.png","images/kane williamson.jpg","images/romario shepherd.jpg","images/umar malik.png","images/nicholas pooran.jpg","images/abhishek.png","images/jansen.png","images/sunder.png","images/bhuvneshwar.png"];
                      ...
                      GestureDetector(
                        ...
                        onTap: (){
                          if (_isMenuVisible) {
                            ...
                            setState(() {
                              batsmanname=names[index];

                            });
                            Navigator.push(context,MaterialPageRoute(builder:(context)=> batsmanteam2()));
