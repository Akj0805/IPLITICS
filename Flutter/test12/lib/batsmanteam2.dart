...
import 'package:test12/batsmanendpage.dart';
...
// );
String output = 'error';
String output2 = 'error';
String output3 = 'error';
String output4 = 'error';
String output5 = 'error';
var teamname = "error";

class batsmanteam2 extends StatefulWidget {
  const batsmanteam2({Key? key}) : super(key: key);

  @override
  _batsmanteam2State createState() =>
      _batsmanteam2State();
...
class _batsmanteam2State extends State<batsmanteam2>
  ...
  //List  urls2 = [CSK(),"images/prithvishaw.png","images/davidwarner.png","images/philipsalt.png","images/lalityadav.png","images/mitchellmarsh.png","images/rovmanpowell.png","images/ripalpatel.png","images/sarfarazkhan.png","images/yashdhull.png","images/rileerossouw.png","images/manishpandey.png"];
                      ...
                      GestureDetector(
                        ...
                        onTap: (){
                          if (_isMenuVisible) {
                            ...
                            // url = 'http://10.0.2.2:5000/api?teamname=' + teamname+'&batsmanname='+batsmanname;
                            url = 'http://ec2-13-50-248-10.eu-north-1.compute.amazonaws.com:8080/api?teamname=' + teamname+'&batsmanname='+batsmanname.toString();
                            print(url);
                            Future<void> abc() async {
                              ...
                              setState(() {
                                output = decoded['accuracy'];
                                output2 = decoded['pred30'];
                                output3 = decoded['pred60'];
                                output4 = decoded['pred90'];
                                output5 = decoded['pred120'];
                              });
                              print('async fucntion is running part 3 '+output+output2);
                            };
                            abc();
                            void navigate() {
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context) => batsmanendpage()));
                            }
