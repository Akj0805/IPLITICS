...
// );
class teamcskinfo extends StatefulWidget {
  const teamcskinfo({Key? key}) : super(key: key);

  @override
  _teamcskinfoState createState() =>
      _teamcskinfoState();
...
class _teamcskinfoState extends State<teamcskinfo>
                ...
                Column(
                  ...
                  children:  [
                    ...
                    Container(
                      ...
                      child:
                      Text(
                        'Chennai Super Kings (CSK) is a cricket team that competes in the Indian Premier League (IPL) and is based in Chennai, Tamil Nadu. MS Dhoni serves as the team\'s captain, and Stephen Fleming is the head coach. The Super Kings have four IPL championships and the highest winning percentage (58.98%) of all the IPL teams. They now hold the record for the most IPL playoff and championship game appearances.',
                        style:  GoogleFonts.abel (
                          // 'Roboto',
                          fontSize:  15.3,
