...
// );
class teamkkrinfo extends StatefulWidget {
  const teamkkrinfo({Key? key}) : super(key: key);

  @override
  _teamkkrinfoState createState() =>
      _teamkkrinfoState();
...
class _teamkkrinfoState extends State<teamkkrinfo>
                ...
                Column(
                  ...
                  children:  [
                    ...
                    Container(
                      ...
                      child:
                      Text(
                        'KKR are a franchise cricket team representing the city of Kolkata in the IPL. The franchise is owned by Bollywood actor Shah Rukh Khan, actress Juhi Chawla and her spouse Jay Mehta. The franchise, which has gained immense popularity due to its association with celebrity owners, qualified for the IPL playoffs for the first time in 2011. They became the IPL champions in 2012, by defeating Chennai Super Kings in the final.',
                        style:  GoogleFonts.abel (
                          // 'Roboto',
                          fontSize:  15.3,
