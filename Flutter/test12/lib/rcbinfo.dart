...
// );
class teamrcbinfo extends StatefulWidget {
  const teamrcbinfo({Key? key}) : super(key: key);

  @override
  _teamrcbinfoState createState() =>
      _teamrcbinfoState();
...
class _teamrcbinfoState extends State<teamrcbinfo>
                ...
                Column(
                  ...
                  children:  [
                    ...
                    Container(
                      ...
                      child:
                      Text(
                        'The Indian Premier Leagues Bengaluru-based cricket team is called Royal Challengers Bangalore, or simply RCB. United Spirits Limited, a member of the Diageo Group, is the teams owner. RCB improved from being in the bottom two in 2008 to place second in 2009 and reach the semifinals in 2010. When they reached the final in 2011, the team enjoyed three consecutive successful seasons. RCB, led by Virat Kohli, finished second once more in 2016.',
                        style:  GoogleFonts.abel (
                          // 'Roboto',
                          fontSize:  15.3,
