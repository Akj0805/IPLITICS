...
// );
class teamrrinfo extends StatefulWidget {
  const teamrrinfo({Key? key}) : super(key: key);

  @override
  _teamrrinfoState createState() =>
      _teamrrinfoState();
...
class _teamrrinfoState extends State<teamrrinfo>
