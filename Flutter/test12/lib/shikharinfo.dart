...
// );
class playershikharinfo extends StatefulWidget {
  const playershikharinfo({Key? key}) : super(key: key);

  @override
  _playershikharinfoState createState() =>
      _playershikharinfoState();
...
class _playershikharinfoState extends State<playershikharinfo>
                ...
                Column(
                  ...
                  children:  [
                    Container(
                      ...
                      padding:  EdgeInsets.fromLTRB(48.5, 0, 24.5, 0),
                      width:  double.infinity,
                      child:
                      Column(
                        crossAxisAlignment:  CrossAxisAlignment.end,
                        children:  [
                          Container(
                            // ipliticsxXA (6:42)
                            margin:  EdgeInsets.fromLTRB(200, 28, 0, 0),
                            width:  double.infinity,
                            child:
                            Text(
                              'IPLitics',
                      ...
                      Stack(
                        children:  [
                          ...
                          Positioned(
                            ...
                            child:
                            Container(
                              margin:  EdgeInsets.fromLTRB(50, 0, 0, 9),
