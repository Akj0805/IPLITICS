...
// );
class playerviratinfo extends StatefulWidget {
  const playerviratinfo({Key? key}) : super(key: key);

  @override
  _playerviratinfoState createState() =>
      _playerviratinfoState();



}

class _playerviratinfoState extends State<playerviratinfo>
